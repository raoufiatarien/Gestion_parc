<?php 
require "header.php"; 
$vehicules = select("maintenance"," INNER JOIN vehicule ON maintenance.id_vehicule = vehicule.matricule INNER JOIN employe ON employe.id_user = maintenance.id_user ");
//var_dump($vehicules);
$n = count($vehicules);
$total = select_sum('cout','maintenance');
?>
          ...
          <div class="col-lg-9 col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h2><i class="fa fa-flag-o red"></i><strong>Liste des maintenances</strong></h2>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $vehicule['nature']; ?></td>
                        <td><?php echo $vehicule['date'];?></td>

                        <td><?php echo $vehicule['cout']; ?></td>
