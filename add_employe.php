...
if(isset($_POST['username'])){
  ...
  $requette = "NULL,'".$_POST['username']."','".$_POST['email']."','".sha1($_POST['password'])."', 'employe'";
  $id_user = insert('user',$requette);
  $requette = $id_user.",'".$_POST['id_employe']."','".$_POST['nom']."','".$_POST['prenom']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['date']."'";
  $id_user = insert('employe',$requette);
          ...
          <div class="col-lg-9 col-md-12">
            ...
            <section class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" method="POST" id="product_form"   enctype="multipart/form-data" action="add_employe.php">
