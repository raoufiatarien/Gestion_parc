<?php 
  if (isset($_POST['vehicule'])) {
    ...
    $requette = "NULL,".$_SESSION['id_user']." ,'".$_POST['vehicule']."','".$type."','".$_POST['date']."','".$description."','".$lieu."'";
    insert('accident',$requette);
            ...
            <section class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal" method="POST" id="product_form"   enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label" style="text-align: left;">Lieu : <i style="color: red">*</i></label>
                    <div class="col-sm-9">
                      <input class="form-control" type="text" required="" name="lieu" >
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label" style="text-align: left;">Description : <i style="color: red">*</i></label>
                    <div class="col-sm-9">
